...
> 目前 1.x 版本将停止新功能的开发，仅对有必要修复的 bug 进行修复，目前主要精力会放在 [2.x](https://github.com/FNOSP/FlyNarwhal/tree/dev-2.x) 分支开发中，2.x 分支使用 Flutter 重写整个项目，以解决之前 1.x 版本中不支持 HDR 视频解码以及 CPU 占用高等问题，敬请期待。
