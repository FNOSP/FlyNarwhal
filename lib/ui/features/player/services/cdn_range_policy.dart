const int cdnRangeChunkSize = 10 * 1024 * 1024;
const int cdnRangeMaxConcurrent = 3;
...
Iterable<CdnByteRange> splitCdnRange(
  CdnByteRange range, {
  int chunkSize = cdnRangeChunkSize,
}) sync* {
...
int cdnRangeConcurrency(
  ...
  return pieces < cdnRangeMaxConcurrent ? pieces : cdnRangeMaxConcurrent;
}
